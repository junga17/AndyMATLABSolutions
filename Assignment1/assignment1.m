...
helpURL = 'http://www.mathworks.com/help/matlab/?w.mathworks.com'
web(helpURL)

% 2. What does the command 'clear all' do?
%
% Answer: Clear all will clear the current workspace.
%
...
%
% Answer: The 2 types of loops that MATLAB supports is a 'for' loop and a
% 'while' loop.  A 'for' loop will repeat a specific number of times and a
% 'while' loop will repeat indefinitely number of times.
% 
...
%
% Answer: NaN stands for not a number. You may get NaN as an answer when
% you calculate sqrt(NaN)
%
...
fprintf('Hello World\n')
prompt = 'Type whatever yout heart desires:';
str = input(prompt, 's')
